...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('charmming_task', 'description',
                      self.gf('django.db.models.fields.CharField')(default='Blank', max_length=150),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.description'
        db.delete_column('charmming_task', 'description')
