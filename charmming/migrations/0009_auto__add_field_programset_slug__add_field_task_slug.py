...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm): 
        db.add_column('charmming_task', 'slug', self.gf('django.db.models.fields.CharField')(default='Blank', max_length=45), keep_default=False)
        db.add_column('charmming_programset', 'slug', self.gf('django.db.models.fields.CharField')(default='Blank', max_length=30), keep_default=False)
 
 
    def backwards(self, orm): 
        db.delete_column('charmming_task', 'slug')
        db.delete_column('charmming_programset', 'slug')
