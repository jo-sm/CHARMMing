...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskGroup.internal_id'
        db.add_column('charmming_taskgroup', 'internal_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'TaskField.internal_id'
        db.add_column('charmming_taskfield', 'internal_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskGroup.internal_id'
        db.delete_column('charmming_taskgroup', 'internal_id')

        # Deleting field 'TaskField.internal_id'
        db.delete_column('charmming_taskfield', 'internal_id')
