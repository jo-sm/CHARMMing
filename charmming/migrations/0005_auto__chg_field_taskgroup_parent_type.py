...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskGroup.parent_type'
        db.alter_column('charmming_taskgroup', 'parent_type', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TaskGroup.parent_type'
        raise RuntimeError("Cannot reverse this migration. 'TaskGroup.parent_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'TaskGroup.parent_type'
        db.alter_column('charmming_taskgroup', 'parent_type', self.gf('django.db.models.fields.CharField')(max_length=15))
