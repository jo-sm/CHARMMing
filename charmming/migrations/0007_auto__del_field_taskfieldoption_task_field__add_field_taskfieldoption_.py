...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskFieldOption.task_field'
        db.delete_column('charmming_taskfieldoption', 'task_field_id')

        # Adding field 'TaskFieldOption.field'
        db.add_column('charmming_taskfieldoption', 'field',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['charmming.TaskField']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TaskFieldOption.task_field'
        raise RuntimeError("Cannot reverse this migration. 'TaskFieldOption.task_field' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'TaskFieldOption.task_field'
        db.add_column('charmming_taskfieldoption', 'task_field',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['charmming.TaskField']),
                      keep_default=False)

        # Deleting field 'TaskFieldOption.field'
        db.delete_column('charmming_taskfieldoption', 'field_id')
