...
urlpatterns = patterns('qsar.views',
    ...
    url(r'^(?P<filename>[\w\.\-\_]+)/property/$','property', name='property'),
    url(r'^(?P<filename>[\w\.\-\_]+)/(?P<qsar_model_id>\d+)/property/$', 'property', name='property'),
    url(r'^(?P<filename>[\w\.\-\_]+)/(?P<qsar_model_id>\d+)/(?P<query>[\w\s\-\_\.]+)/(?P<num_mols>\d+)/property/$', 'property', name='property'),
