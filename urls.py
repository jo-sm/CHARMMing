...
urlpatterns = patterns('',
    ...
    (r'^charmming/qchem/$', 'qchem.views.qchemdisplay'),
    (r'^charmming/qchem/submit/','qchem.views.qchem_submit'),
    (r'^charmming/selection/', 'selection.views.selectstructure'),
    (r'^charmming/get_qmmm_vars/', 'selection.views.get_param_vars'),
    (r'^charmming/get_qmmm_tpl/', 'selection.views.get_param_template'),
...
#    (r'^charmming/viewdynamicoutput/$', 'structure.views.viewDynamicOutput'),
    ...
    #download stuff
    (r'^charmming/download_table/(?P<path>.*)$', 'download.views.fetch_path'),
    (r'^charmming/download/$', 'download.views.download_files_display'),
    ...
    (r'^charmming/dd_infrastructure/bindingsite/$', 'dd_infrastructure.views.displayBindingForm'),
    (r'^charmming/dd_infrastructure/binding_submit/$', 'dd_infrastructure.views.submitBindingForm'),
