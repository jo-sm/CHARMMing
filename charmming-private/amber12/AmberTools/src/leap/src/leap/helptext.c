...
\n\
  dipole_damp_factor	real\n\
                                sets the default value for \"DIPOLE_DAMP_FACTOR\" \n\
                                for dipole screening factors in Thole models.\n\
                                Valid value > 0.0\n\
\n\
  sceescalefactor	real\n\
                                sets the default value for \"SCEE_SCALE_FACTOR\" \n\
                                for 1-4 EEL scaling factors. Valid value > 0.0.\n\
                                Default=1.2.\n\
\n\
  scnbscalefactor	real\n\
                                sets the default value for \"SCNB_SCALE_FACTOR\" \n\
...
\n\
  ipol              integer\n\
                                Sets the default value for IPOL.\n\
...
Set Default command. Without variable, with \"all\" or \"*\", all default\n\
variables are shown.\n\
\n\
\n" );
    HelpAdd( "solvateBox", "\
