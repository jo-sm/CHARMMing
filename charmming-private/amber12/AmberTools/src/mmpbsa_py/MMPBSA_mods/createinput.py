   ...
   if INPUT['decomprun']:
      ...
      if INPUT['gbrun']:
         if stability:
            ...
            com_mdin.write_input('_MMPBSA_gb_decomp_com.mdin')
         else:
            rec_res = ['Residues considered as REC', full_rc]
            ...
            com_mdin.write_input('_MMPBSA_gb_decomp_com.mdin')
            rec_mdin.write_input('_MMPBSA_gb_decomp_rec.mdin')
            lig_mdin.write_input('_MMPBSA_gb_decomp_lig.mdin')
      if INPUT['pbrun']:
         if stability:
            rec_res = ['Residues considered as REC', full_rc]
            pri_res = ['Residues to print', com_card]
            com_mdin = SanderPBDecomp(INPUT, rec_res, pri_res)
            com_mdin.write_input('_MMPBSA_pb_decomp_com.mdin')
         else:
            rec_res = ['Residues considered as REC', full_rc]
            lig_res = ['Residues considered as LIG', full_lc]
            pri_res = ['Residues to print', com_card]
            ...
            com_mdin.write_input('_MMPBSA_pb_decomp_com.mdin')
            rec_mdin.write_input('_MMPBSA_pb_decomp_rec.mdin')
            lig_mdin.write_input('_MMPBSA_pb_decomp_lig.mdin')
      ...
      if INPUT['gbrun']:
         ...
         if gb_prog == 'mmpbsa_py_energy':
            ...
            if INPUT['ifqnt']:
               ...
               gb_mdin.write_input('_MMPBSA_gb_qmmm_com.mdin')
               if not stability:
                  ...
                  gb_mdin.write_input('_MMPBSA_gb_qmmm_rec.mdin')
                  ...
                  gb_mdin.write_input('_MMPBSA_gb_qmmm_lig.mdin')
            else:
               gb_mdin = SanderGBInput(INPUT)

         gb_mdin.write_input('_MMPBSA_gb.mdin')
      ...
      if INPUT['pbrun']:
         ...
         pb_mdin.write_input('_MMPBSA_pb.mdin')
   ...
   if INPUT['entropy']: # quasi-harmonic approximation input file
      ...
      if not INPUT['mutant_only']:
         qh_in = QuasiHarmonicInput(com_mask, rec_mask, lig_mask,
                  stability=stability, prefix='_MMPBSA_', trj_suffix=trj_suffix)
         qh_in.write_input('_MMPBSA_ptrajentropy.in')
      if INPUT['alarun']:
         qh_in = QuasiHarmonicInput(com_mask, rec_mask, lig_mask,
                  stability=stability, prefix='_MMPBSA_mutant_',
                  trj_suffix=trj_suffix)
         qh_in.write_input('_MMPBSA_mutant_ptrajentropy.in')
...
class SanderGBInput(SanderInput):
   ...
   input_items = {'ntb':0,    'cut':999.0,    'nsnb':99999,
                  ...
                  'gbsa':1,   'extdiel':80.0, 'surften':0.0072,
                  'ioutfm':0, 'idecomp':0,    'offset':0.0,
   ...
   name_map = {'igb':'igb',  'saltcon':'saltcon', 'intdiel':'intdiel',
               ...
               'offset':'surfoff', 'idecomp':'idecomp', 'ioutfm':'netcdf',
               'qmmask':'qmmask', 'qm_theory':'qm_theory', 'ifqnt':'ifqnt',
               'qmcharge':'qmcharge', 'qmcut':'qmcut', 
