...
class NMODEout(object):
   ...
   def __init__(self, basename, num_files=1, temperature=298.15):
      self.basename = basename
   ...
   def fill_composite_terms(self): pass
   ...
   def _get_energies(self, outfile):
      ...
      while rawline:
         ...
         if rawline[0:5] == ' BOND':
            ...
            words = outfile.readline().split()
            self.data['ESURF'].append(float(words[2]))
      ...
      while rawline:
         ...
         if rawline[0:5] == ' BOND':
            ...
            if words[0] != 'ESURF':
               ...
               words = outfile.readline().split() # ESURF is here now
            else:
...
class BindingStatistics(object):
   ...
   def __init__(self, com, rec, lig, verbose=1, chamber=False):
      ...
      if (type(self.com).__name__ != type(self.rec).__name__ or
          type(self.com).__name__ != type(self.lig).__name__):
      ...
      try: self.delta()
      except LengthError: self.delta2()
