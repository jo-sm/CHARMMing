...
try:
   ...
   from cpinutils.cpin_utilities import *
...
try:
   for x in range(1,len(sys.argv)):
      ...
      # Get arbitrary num of resnames to remove from the list
         ...
         raise IndexError('Bad command-line flag ' + sys.argv[x])
...
if not ignore_warn:
   if radius_set != 'H(N)-modified Bondi radii (mbondi2)' and igb != '8':
      ...
      print >> sys.stderr, 'Error: mbondi3 radius set should be used for constant pH simulations using igb=8. All reference energies'
      print >> sys.stderr, '       were calculated using these radii! Set --ignore-warnings to ignore this warning.'
      sys.exit()
