/* ************************************************************* *
   CifArray.c: Basic array class template implementation.
...
template<class TYPE> unsigned CifArray<TYPE>::CheckIndex(unsigned int i) const
// ---------------------------------------------------------------
...
{
  if (i >= DimLength()) 
    i = HandleRangeError("CifArray", i, DimLength());
...
template<class TYPE>  void CifArray<TYPE>::CopyN(const TYPE *s, unsigned slen)
// ---------------------------------------------------------------
