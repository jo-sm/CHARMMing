...
static struct name_val const month_names[] = {
	...
	{"july",6}, {"august",7}, {"sepember",8}, {"october",9}, {"november",10},
	{"december",11},
	{"", TM_UNDEFINED}
};
...
*/
{
	...
	static char const *
parse_decimal (char const *s, int digits, int lo, int hi, int resolution, int *res, 
      int *fres)
/*
* Parse an initial prefix of S of length DIGITS;
* it must be a number in the range LO through HI
...
*/
{
	...
	switch (c) {
		...
		case 'E': /* extended day of month [1-9, 01-31] */
			/* Modified by Shu-Hsin here, Check the digit of
			 * input numbers
			 */
