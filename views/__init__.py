...
from views.mixins import LoggedInMixin, AdminMixin
from charmming.models import User, Session

class DashboardView(LoggedInMixin, generic.TemplateView):
...
class LogoutView(LoggedInMixin, generic.TemplateView):
  def get(self, request, *args, **kwargs):
