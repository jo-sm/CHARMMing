...
--
-- Host: localhost    Database: charmming
-- ------------------------------------------------------
...
--
-- Table structure for table `qsar_model_types`
--
...
INSERT INTO `qsar_model_types` VALUES (1,'Random Forest (QSAR) Regression',''),(2,'Random Forest (SAR) Categorization','');
...
-- Dump completed on 2013-07-26 17:45:54
