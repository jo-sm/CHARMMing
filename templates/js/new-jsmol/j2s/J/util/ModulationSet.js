...
function (id, r, vocc0, modDim, mods, gammaE, gammaIS, q123, qlen) {
...
gammaIS.get (sI);
gammaIinv.invert ();
this.x456 = J.util.V3.new3 (q123[0].dot (r), q123[1].dot (r), q123[2].dot (r));
this.x456.sub (sI);
gammaIinv.transform (this.x456);
if (J.util.Logger.debuggingHigh) J.util.Logger.debug ("MODSET create r=" + J.util.Escape.eP (r) + " q0=" + J.util.Escape.eP (q123[0]) + " si=" + J.util.Escape.eP (sI) + " ginv=" + gammaIinv.toString ().$replace ('\n', ' ') + " x4=" + this.x456.x);
this.qlen = qlen;
}, "~S,J.util.P3,~N,~N,J.util.JmolList,J.util.Matrix3f,J.util.Matrix4f,~A,~A");
$_M(c$, "calculate", 
function () {
