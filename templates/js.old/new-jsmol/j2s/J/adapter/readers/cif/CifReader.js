...
Clazz.load (["J.adapter.readers.cif.ModulationReader", "J.api.JmolLineReader", "J.io.CifDataReader", "J.util.JmolList", "$.P3"], "J.adapter.readers.cif.CifReader", ["java.io.BufferedReader", "$.StringReader", "java.lang.Boolean", "$.Character", "$.Float", "java.util.Hashtable", "J.adapter.smarter.Atom", "$.Structure", "J.api.JmolAdapter", "J.constant.EnumStructure", "J.util.BS", "$.Logger", "$.Matrix4f", "$.TextFormat"], function () {
...
this.addSubsystem (subid, null, atom.atomName);
}}
if (this.isPDB) this.setIsPDB ();
this.atomSetCollection.setAtomSetAuxiliaryInfo ("isCIF", Boolean.TRUE);
